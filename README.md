...
- **Side slide switch** on GPIO3 is repurposed as the LED ring on/off (Home Assistant AirPlay doesn't use the microphone).
...
| `components/ha_airplay_ui/README.md` | Encoder, button, mute slide |
